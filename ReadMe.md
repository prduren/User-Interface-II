...
- [ yes] Add your Team Lead as collaborator on Github.
...
- [ yes] A navigation bar with `About`, `Projects`, and `Contact` that link to the corresponding pages
- [yes ] Gallery of projects created with flexbox - you may use random images in place of project screenshots for now with the random image link: https://picsum.photos/ or you may use images that mean something to you
- [yes ] Information about you in place of the given placeholder
- [yes] A `My Projects` button that links to the projects page
- [ yes] A `Contact Me` button that links to the contact page
